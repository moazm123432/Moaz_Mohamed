...
* 🐍 Python Developer
* 🎨 Qt Quick / QML Developer
* 🖥️ Building Desktop Applications
* ⚡ Interested in Software Architecture & UI Design
...
class Moaz:
    ...
    def current_focus(self):
        return "Building modern desktop applications with Python & QML"
```
